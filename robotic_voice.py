...
# apply_vocoder("audios/output.wav", "audios/vocoder_1.wav", "audios/carrier.wav")
...
# apply_vocoder("audios/output.wav", "audios/vocoder_2.wav", "audios/carrier.wav", speech_volume=0.5, vocoder_volume=1)